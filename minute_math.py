#This code comes from 100_plus_python_projects_challenge
#Added personal adjustments to original code
import time
import random
...
if __name__ == '__main__':
    ...
    correct = 0
    questions = []
    decision = input('Welcome to 1 minute math! Do you want to play? (y/n): ')
    if decision.lower() == 'y':
        pass
    else:
        quit()
